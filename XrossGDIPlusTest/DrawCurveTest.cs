...
namespace XrossOneGDIPlusTest
{
	...
	{
		public DrawCurveTest(MainForm form):base(form)
		{
		}
		protected override void DoXrossOneTest()
		{
			...
			PenX pen2 = new PenX(Color.FromArgb(0xA0, Color.Green), 10);
			...
			pen2.Color = Color.FromArgb(0x80, Color.Red);
			pen2.Width = 15;
			//gx.DrawClosedCurve(pen2, curvePoints2);
			BrushX brush = new SolidBrushX(Color.FromArgb(0xA0, Color.Red));
		...
		protected override void DoNativeTest()
		{
			...
			Pen pen2 = new Pen(Color.FromArgb(0xA0, Color.Green), 10);
			// Create points that define curve.
			Point point1 = new Point( 50,  50);
			Point point2 = new Point(100,  25);
			Point point3 = new Point(200,   150);
			...
			// Draw lines between original points to screen.
			//g2.DrawLines(pen1, curvePoints);
			// Create offset, number of segments, and tension.
			int offset = 0;
			int numSegments = 6;
			float tension = 1f;
			// Draw curve to screen.
			g2.DrawCurve(pen2, curvePoints, offset, numSegments, tension);
			//g2.DrawClosedCurve(greenPen, curvePoints);
			Point p1 = new Point(150,  20);
			Point p2 = new Point(100,  230);
			Point p3 = new Point(240,  150);
			Point p4 = new Point(60,  150);
			...
			//g2.DrawPolygon(pen1, curvePoints2);
			pen2.Color = Color.FromArgb(0x80, Color.Red);
			pen2.Width = 15;
			//g2.DrawClosedCurve(pen2, curvePoints2);
			Brush brush = new SolidBrush(Color.FromArgb(0xA0, Color.Red));
			g2.FillClosedCurve(brush, curvePoints2);
		}	
	}
}

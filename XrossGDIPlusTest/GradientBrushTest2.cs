...
namespace XrossOneGDIPlusTest
{
	...
	/// </summary>
	public class GradientBrushTest2:GDITest
	{
		public GradientBrushTest2(MainForm form):base(form)
		{
		}
		...
		{
			Rectangle r = new Rectangle(20, 50,  170, 100);
			LinearGradientBrush br = new LinearGradientBrush(r,Color.Black,Color.Black,60F,false); 
			...
			r.Y += 120;
			LinearGradientBrush brush2 = new LinearGradientBrush(r, Color.Black,Color.Black, 90F,false); 
			brush2.InterpolationColors = cb;
			...
			brush2 = new LinearGradientBrush(r, Color.Black,Color.Black, 220F); 
			brush2.InterpolationColors = cb;
			g2.RotateTransform(-45F);
			g2.TranslateTransform(-200, -200);
			g2.FillRectangle(brush2, r);
		}	
	}
}

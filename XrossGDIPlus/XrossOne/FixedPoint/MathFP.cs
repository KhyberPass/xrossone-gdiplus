...
namespace XrossOne.FixedPoint
{
	public class MathFP
	{
		...
		public static int Sin(int ff_ang)
		{
			float ang = ff_ang / (float)SingleFP.One;
			return (int)(Math.Sin(ang) * SingleFP.One);
		}
		/*
		...
		*/
		...
		{
			float ang = ff_ang / (float)SingleFP.One;
			return (int)(Math.Cos(ang) * SingleFP.One);
		}
		
		public static int Tan(int ff_ang)
		{
			float ang = ff_ang / (float)SingleFP.One;
			return (int)(Math.Tan(ang) * SingleFP.One);
		}

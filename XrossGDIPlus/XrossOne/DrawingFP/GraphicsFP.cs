...
namespace XrossOne.DrawingFP
{
	public sealed class GraphicsFP
	{
		...
		internal GraphicsPathRenderer renderer;// = new GraphicsPathRenderer();
		private int paintMode;
		//internal System.Drawing.Bitmap bufferedImage;
		private MatrixFP matrix = null;

		public GraphicsFP(int width, int height):this(new SimpleGraphicsBuffer(width, height))
		{
		}
		public GraphicsFP(IGraphicsBuffer buffer)
		{
			renderer = new GraphicsPathRenderer(buffer);

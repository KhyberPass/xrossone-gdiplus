...
{
	public class SolidBrushX : BrushX
	{
		SolidBrushFP brushFP;
		...
		public SolidBrushX(Color color)
		{
			brushFP = new SolidBrushFP(color.ToArgb());
		}
		public Color Color
		{
			get
			{
				return Color.FromArgb(brushFP.color);
			}
			set
			{
				brushFP.color = value.ToArgb();
			}
		}
	}
}

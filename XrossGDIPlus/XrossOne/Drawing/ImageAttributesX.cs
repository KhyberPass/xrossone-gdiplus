...
{
	public class ImageAttributesX
	{
		internal int colorLow = -1;
		internal int colorHigh = -1;
		public ImageAttributesX()
		{
			
		}
		public void SetColorKey(Color colorLow,Color colorHigh)
		{
			this.colorLow = colorLow.ToArgb() & 0xFFFFFF;
			this.colorHigh = colorHigh.ToArgb() & 0xFFFFFF;
		}
		public void SetColorKey(int colorLow,int colorHigh)
		{
			this.colorLow = colorLow & 0xFFFFFF;
			this.colorHigh = colorHigh & 0xFFFFFF;
		}
	}
}

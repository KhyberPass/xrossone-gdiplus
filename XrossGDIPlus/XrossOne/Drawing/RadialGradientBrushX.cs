...
{
	public class RadialGradientBrushX : GradientBrushX
	{
		protected override int GradientType
		{
			get
			{
				return GradientBrushFP.RADIAL_GRADIENT;
			}
		}

		public RadialGradientBrushX (Point point1, Point point2, Color color1, Color color2):
			base(new PointF(point1.X, point1.Y), new PointF(point2.X, point2.Y), color1, color2)
		{
		}

		public RadialGradientBrushX (PointF point1, PointF point2, Color color1, Color color2):
			base(point1, point2, color1, color2)
		{
		}

		public RadialGradientBrushX (Rectangle rect, Color color1, Color color2):
			base(rect, color1, color2, 0F)
		{
		}

		public RadialGradientBrushX (Rectangle rect, Color color1, Color color2, float angle):
			base(rect, color1, color2, angle)
		{
		}

		public RadialGradientBrushX (RectangleF rect, Color color1, Color color2):
			base(rect, color1, color2, 0F)
		{
		}

		public RadialGradientBrushX (RectangleF rect, Color color1, Color color2, float angle):
			base(rect, color1, color2, angle)
		{
		}
	}

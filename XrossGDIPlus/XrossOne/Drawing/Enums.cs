...
namespace XrossOne.Drawing
{
	...
	public enum CompositingModeX 
	{
		SourceCopy = 1,
		SourceOver = 0
	}
	public enum PenTypeX 
	{
		HatchFill = 1,
		LinearGradient = 4,
		PathGradient = 3,
	...
	public enum MatrixOrderX 
	{
		Append = 1,
		Prepend = 0
	}
	public enum FillModeX 
	{
		Alternate = 0,
		Winding = 1
	}
	public enum LinearGradientModeX 
	{
		BackwardDiagonal = 3,
		ForwardDiagonal = 2,
		Horizontal = 0,

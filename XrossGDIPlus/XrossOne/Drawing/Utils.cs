...
namespace XrossOne.Drawing
{
	...
	public class Utils
	{
		...
		public static PointFP ToPointFP(int x, int y)
		{
			return new PointFP(SingleFP.FromInt(x), SingleFP.FromInt(y));
		}
		public static PointFP ToPointFP(Point pnt)
		{
			return new PointFP(SingleFP.FromInt(pnt.X), SingleFP.FromInt(pnt.Y));
		}
		public static PointFP ToPointFP(float x, float y)
		{
			return new PointFP(SingleFP.FromFloat(x), SingleFP.FromFloat(y));
		}
		...
		public static double TransformAngle(double a, double width, double height)
		{
			a = a * Math.PI / 180;
